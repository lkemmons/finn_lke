...
; for achive fires, call from shell script
;**************************************************************

pro finn2_9_1_calc_emis_archive
  ...
  path_in = '/glade/campaign/acom/acom-weather/emmons/emissions_finn/finn2.9/processedfires'

  ; output emissions text files
  path_out = '/glade/campaign/acom/acom-weather/emmons/emissions_finn/finn2.9/emis_txt_v2.9.1'
  finnver = 'v2.9.1'
